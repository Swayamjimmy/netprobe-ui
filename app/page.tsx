    ...
    {!activeTarget ? (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-2xl">
          ...
          <h3 className="text-lg font-semibold text-gray-200 mb-2">Global Routing Analysis</h3>
          <p className="text-gray-400 text-sm leading-relaxed">Map the exact geographical path your packets take using Globalping probes to detect mid-path anomalies.</p>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-2xl">
          <div className="text-2xl mb-3">⚡</div>
          <h3 className="text-lg font-semibold text-gray-200 mb-2">Identify ISP Throttling</h3>
          <p className="text-gray-400 text-sm leading-relaxed">Compare high-frequency ICMP ping latency against actual HTTP download throughput to spot artificial bottlenecks.</p>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-2xl">
          <div className="text-2xl mb-3">🧠</div>
          <h3 className="text-lg font-semibold text-gray-200 mb-2">Automated RCA</h3>
          <p className="text-gray-400 text-sm leading-relaxed">Instead of guessing, the AI classifier analyzes packet loss, jitter, and DNS resolution times to provide a definitive root cause.</p>
        </div>
      </div>
    ) : (
